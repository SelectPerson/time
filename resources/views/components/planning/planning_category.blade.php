<div class="right__inner__high">
    <div class="category main__right__category" id="category__planning__select">
        ...
        <ul class="category__list">
            @foreach($getCategoryMark as $category_elem)
                @if ($category_elem->category_mark == 1)
                    <li class="category__elem category__elem__select category__elem__planning">
                        {{ $category_elem->name }}
                    </li>
                @elseif ($category_elem->category_mark == 0)
                    <li class="category__elem category__elem__planning">
                        {{ $category_elem->name }}
                    </li>
                @endif
        ...
        <div class="save_category_planning">Зберегти</div>
        <style>
            .save_category_planning {
